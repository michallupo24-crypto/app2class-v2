        ...
        <Card>
          <CardContent className="py-3 px-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-heading font-medium">צלצולים</span>
            </div>
            <div className="flex gap-2 flex-wrap">
              {bell.slice(0, 13).map(b => (
                <Badge key={b.lesson_number} variant="outline" className="text-[10px] gap-1 py-1">
                  {b.label || `${b.lesson_number}`}: {b.start_time}-{b.end_time}
                </Badge>
              ))}
            </div>
          </CardContent>
