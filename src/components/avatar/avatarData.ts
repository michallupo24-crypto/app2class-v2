...
// Additive avatar traits: the underlying face/body art has no layers for these,
// so they render as glow + badge accents around the frame rather than on-face overlays.
export const EXPRESSIONS = [
  { key: "happy", label: "שמח", glow: "45 96% 56%" },
  { key: "excited", label: "נלהב", glow: "330 81% 60%" },
  { key: "calm", label: "רגוע", glow: "199 89% 48%" },
  { key: "focused", label: "מרוכז", glow: "280 67% 55%" },
  { key: "cool", label: "מגניב", glow: "217 91% 50%" },
] as const;
...
export const FACIAL_HAIR_OPTIONS = [
  { key: "none", label: "ללא" },
  { key: "mustache", label: "שפם" },
  { key: "beard", label: "זקן" },
  { key: "goatee", label: "זקנקן" },
] as const;

export const OUTFITS = [
  { key: "hoodie", label: "קפוצ'ון" },
  { key: "tshirt", label: "חולצת טי" },
  { key: "formal", label: "חולצה מכופתרת" },
  { key: "dress", label: "שמלה" },
] as const;

export const BACKGROUNDS = [
  { label: "שמיים", hex: "#E0F2FE" },
  { label: "ורוד", hex: "#FCE7F3" },
  { label: "ירוק", hex: "#DCFCE7" },
